...
import logo from '../../../assets/images/crypto_flowers.svg'
    ...
    render() {
        return (
            <div className={styles.hero}>
                ...
                {/* <svg className={styles.svg} width="600" height="290" viewBox="0 0 600 280" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" svg="http://www.w3.org/2000/svg">
                    <g>
